module.exports = {
  SUCCESS_200: {
    ...
    description:
      "Đáp ứng thực tế sẽ phụ thuộc vào phương thức yêu cầu được sử dụng.",
  },
  ...
  ERR_400: {
    ...
    description:
      "Máy chủ không thể hoặc sẽ không xử lý yêu cầu do lỗi máy khách rõ ràng (ví dụ: cú pháp yêu cầu không đúng định dạng, kích thước quá lớn, khung tin nhắn yêu cầu không hợp lệ hoặc định tuyến yêu cầu lừa đảo)",
  },
  ...
  ERR_404: {
    ...
    description:
      "Không thể tìm thấy tài nguyên được yêu cầu nhưng có thể có sẵn trong tương lai. Các yêu cầu tiếp theo của khách hàng được cho phép",
  },
  ...
  ERR_500: {
    ...
    description:
      "Một thông báo lỗi chung, được đưa ra khi gặp phải một điều kiện bất ngờ và không có thông báo cụ thể nào phù hợp hơn",
  },
};
